...
function Clock() {
    ...
    const start = () => {
        ...
        let tID = window.setInterval(()=>setDate(new Date()), 1000)
        setDate(new Date())
        setTimerId(tID)
    }
    ...
    let date1= new Intl.DateTimeFormat("ru")
    const stringTime = time.format(date) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate = date1.format(date) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
